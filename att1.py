...
# img declaration
joshik = face_rec.load_image_file('C:/Users/darshika/Desktop/smartattendance/darshika.jpg')
joshik = cv2.cvtColor(joshik, cv2.COLOR_BGR2RGB)
joshik = resize(joshik, 0.50)
joshik_test = face_rec.load_image_file('C:/Users/darshika/Desktop/smartattendance/darshikatest.jpg')
